    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <form class="custom-border" action="?action=update&controller=admin" method="post">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="level" value="<?php echo $each->getLevel() ?>"
                            placeholder="Ex: 1, 2">
                    </div>
                    <div class="mb-3">
                        <label for="status" class="form-label">Status</label>
                        <input type="text" class="form-control" name="status" value="<?php echo $each->getStatus() ?>"
                            placeholder="">
                    </div>
